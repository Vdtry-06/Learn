package Code_PTIT.File_Input_And_Output.J07016;
...
public class Main {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        for(int n: arrayList1) {
            if(Prime(n)) treeMap1.put(n, treeMap1.getOrDefault(n, 0) + 1);
        }
        ...
        for(int n: arrayList2) {
            if(Prime(n)) treeMap2.put(n, treeMap2.getOrDefault(n, 0) + 1);
        }
